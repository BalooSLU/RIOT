...
int main(void)
{
  ...
  while (1) {
		...
		case 4:
			...
			/*showText_t * size =(showText_t *) malloc(sizeof(showText_t));
			if(size != NULL)addParam(size, "new2", "2");
			else puts("empty space\n");*/
